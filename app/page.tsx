...
export default function HomePage() {
  return (
    <main
      className="bg-white max-h-screen gap-4 flex flex-col items-center justify-center"
      role="main"
    >
      <div className="flex flex-col items-center px-[clamp(10px,3vw,28px)] text-center">
        <Hero />
